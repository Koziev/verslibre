...
if __name__ == '__main__':
    ...
    xwords = 'вдвоЁм разъЁм пъЯнки птИцэй жОлтый шОпот тишынА сжыгАю соцыАльная магнитозавИсимыми электрощЁточную'.split() +\
